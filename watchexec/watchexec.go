...
func NewWatchexec(dependency libpak.BuildpackDependency, cache libpak.DependencyCache) (Watchexec, libcnb.BOMEntry) { //nolint:staticcheck // hold off on the BOM migration for now
